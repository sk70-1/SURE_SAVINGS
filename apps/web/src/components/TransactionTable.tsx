    ...
    <div className="glass-panel rounded-2xl p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-[#eae8e3] gap-3">
        <div>
          ...
          <p className="text-xs text-[#6b7280] mt-0.5">
            Your recent earnings and daily expenses ({transactions.length} total)
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2.5">
          ...
          {onOpenAddTransaction && (
            <button
              ...
              className="px-3 py-1.5 text-xs font-bold text-[#ff5b45] bg-[#fff5f3] hover:bg-[#ffe8e4] border border-[#ffdad4] rounded-xl flex items-center space-x-1.5 transition-all shadow-sm"
            >
      ...
      {transactions.length === 0 ? (
        ...
        <div className="py-12 text-center flex flex-col items-center justify-center">
          ...
          <h4 className="text-sm font-bold text-[#111827] mb-1">No Transactions Recorded Yet</h4>
          ...
          {onOpenAddTransaction && (
            <button
              onClick={onOpenAddTransaction}
              className="px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-[#ff5b45] to-[#f05138] rounded-xl shadow-md flex items-center space-x-1.5"
            >
                    ...
                    {onDeleteTransaction && (
                      <td className="py-3 text-center">
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 p-1 text-[#9ca3af] hover:text-[#e11d48] rounded-lg transition-all"
